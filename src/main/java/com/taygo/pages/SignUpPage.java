...
public class SignUpPage extends DriverFactory {
    ...
    public String expectedGoogleReviewAppName = "Sync Google Business Profile";
    ...
    @FindBy (xpath = "//*[@name='first_name']/../following-sibling::p")
    public WebElement fnErrorText;

    @FindBy (xpath = "//*[@name='last_name']/../following-sibling::p")
    public WebElement lnErrorText;

    @FindBy (xpath = "//*[@name='email']/../following-sibling::p")
    public WebElement emailErrorText;

    @FindBy (xpath = "//*[@name='mobileno']/../following-sibling::p")
    public WebElement mobileErrorText;

    //*[@name='first_name']/../following-sibling::p
    ...
    @FindBy (xpath = "(//*[text()='Sync Google Business Profile'])[1]")
...
/*        verificationCodeTextFields.get(0).sendKeys(String.valueOf(mobileVerificationCode.charAt(0)));
    ...
    public void googleReview () {
        ...
        Assert.assertTrue ("Verify App Name" , googleReviewsAppNameTxt.getText ().contains (expectedGoogleReviewAppName));
